...
CREATE TABLE [T_RRHH_PERFORMANCE_EVALUATIONS_RECOMMENDATIONS] (
  ...
  [RECOMMENDATION_DESCRIPTION] varchar(3000 ) NOT NULL CHECK (LEN([RECOMMENDATION_DESCRIPTION]) > 0 AND LEN (RECOMMENDATION_DESCRIPTION)<=3000),
)
GO
...
CREATE TABLE [T_RRHH_PERFORMANCE_EVALUATIONS_TYPES] (
  ...
  [IDE_COMPANY] uniqueidentifier NOT NULL,
  [TYPE_EVALUATION] nvarchar(255) NOT NULL UNIQUE,
  [DESCRIPTION] varchar(255)
)
GO

CREATE TABLE [T_RRHH_QUESTION_TEMPLATES] (
